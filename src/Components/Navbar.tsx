  ...
  return (
    <nav className="position">
      <div className="mx-auto hidden sm:block">
        {/* nav one  */}
        <div
          className={`nav-1 lg:justify-between sm:hidden lg:flex ${
            show && "nav-hidden"
          }`}
        >
        ...
        {/* nav two  */}
        <div
          className={`nav-2-fixed ${show && "nav-2-top"} ${
            !show && "nav-2-animation"
          }`}
        >
          <div
            onMouseEnter={handleMouseLeave}
            className={`flex nav-2 ${hoverHide && "nav-Hide"} 
          bg-[#ffffffcc]  nav-border-left nav-border-right
           ${show && "nav-border-left-none nav-border-right-none"}`}
          >
            <div
              className={`style-1 flex-none w-[4%] py-4  nav-border-left ${
                show && "nav-border-left-none"
              }`}
            ></div>
            ...
            <div
              className={`style-2 flex-none ${
                hoverHide && "nav-Hide"
              } w-[4%] py-4 nav-border-right ${
                show && "nav-border-right-none"
              }`}
            ></div>
          </div>
        </div>
      </div>
      <div className="bg-[#0978]">
      ...
      <div
        className={`${
          open ? "block" : "hidden"
        } absolute z-20 w-full md:hidden bg-[#0978] opacity-90`}
      >
